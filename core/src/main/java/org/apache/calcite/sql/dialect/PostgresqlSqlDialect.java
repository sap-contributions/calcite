...
public class PostgresqlSqlDialect extends SqlDialect {
  ...
  public SqlConformance getConformance() {
    ...
    return new SqlConformance() {
      @Override
      public boolean isLiberal() {
        return conformance.isLiberal();
      }

      @Override
      public boolean allowCharLiteralAlias() {
        return conformance.allowCharLiteralAlias();
      }
      ...
      public boolean isGroupByOrdinal() {
        return conformance.isGroupByOrdinal();
      }

      @Override
      public boolean isHavingAlias() {
        return conformance.isHavingAlias();
      }

      @Override
      public boolean isSortByOrdinal() {
        return conformance.isSortByOrdinal();
      }

      @Override
      public boolean isSortByAlias() {
        return conformance.isSortByAlias();
      }

      @Override
      public boolean isSortByAliasObscures() {
        return conformance.isSortByAliasObscures();
      }

      @Override
      public boolean isSupportedDualTable() {
        return conformance.isSupportedDualTable();
      }

      @Override
      public boolean isFromRequired() {
        return conformance.isFromRequired();
      }

      @Override
      public boolean splitQuotedTableName() {
        return conformance.splitQuotedTableName();
      }

      @Override
      public boolean allowHyphenInUnquotedTableName() {
        return conformance.allowHyphenInUnquotedTableName();
      }
      ...
      public boolean isPercentRemainderAllowed() {
        return conformance.isPercentRemainderAllowed();
      }

      @Override
      public boolean isMinusAllowed() {
        return conformance.isMinusAllowed();
      }

      @Override
      public boolean isApplyAllowed() {
        return conformance.isApplyAllowed();
      }

      @Override
      public boolean isInsertSubsetColumnsAllowed() {
        return conformance.isInsertSubsetColumnsAllowed();
      }

      @Override
      public boolean allowAliasUnnestItems() {
        return conformance.allowAliasUnnestItems();
      }

      @Override
      public boolean allowNiladicParentheses() {
        return conformance.allowNiladicParentheses();
      }

      @Override
      public boolean allowNiladicConstantWithoutParentheses() {
        return conformance.allowNiladicConstantWithoutParentheses();
      }

      @Override
      public boolean allowExplicitRowValueConstructor() {
        return conformance.allowExplicitRowValueConstructor();
      }

      @Override
      public boolean allowExtend() {
        return conformance.allowExtend();
      }

      @Override
      public boolean isLimitStartCountAllowed() {
        return conformance.isLimitStartCountAllowed();
      }

      @Override
      public boolean isOffsetLimitAllowed() {
        return conformance.isOffsetLimitAllowed();
      }

      @Override
      public boolean allowGeometry() {
        return conformance.allowGeometry();
      }

      @Override
      public boolean shouldConvertRaggedUnionTypesToVarying() {
        return conformance.shouldConvertRaggedUnionTypesToVarying();
      }

      @Override
      public boolean allowExtendedTrim() {
        return conformance.allowExtendedTrim();
      }
      ...
      public boolean isValueAllowed() {
        return conformance.isValueAllowed();
      }

      @Override
      public SqlLibrary semantics() {
        return conformance.semantics();
      }

      @Override
      public boolean allowLenientCoercion() {
        return conformance.allowLenientCoercion();
      }

      @Override
      public boolean checkedArithmetic() {
        return conformance.checkedArithmetic();
      }
    };
  }
}
